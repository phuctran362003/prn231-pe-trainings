...
INSERT INTO WatercolorsPainting VALUES(N'WP00111', N'The Starry Night', N'This iconic painting depicts a dramatic, swirling night sky over a tranquil village, showcasing van ghs distinctive style and use of bold, expressive brushwork.', N'Vincent van gh', 1099, 1889, CAST(N'2024-2-16' AS DateTime), 'SS00112')
...
INSERT INTO WatercolorsPainting VALUES(N'WP00114', N'Sunflowers', N'This vibrant still life of sunflowers showcases his use of bold colors and distinctive brushwork, capturing the beauty and vitality of the flowers', N'Vincent van gh', 1249, 1888, CAST(N'2024-2-16' AS DateTime), 'SS00118')
...
INSERT INTO WatercolorsPainting VALUES(N'WP00118', N'Church at Auvers', N'This painting depicts the church in Auvers-sur-Oise with expressive brushwork, capturing the architectural details and the surrounding landscape with emotive and vibrant colors', N'Vincent van gh', 1449, 1890, CAST(N'2024-2-16' AS DateTime), 'SS00155')

...
public partial class WatercolorsPainting2024DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.StyleId).HasName("PK__Style__8AD146401C2243C6");
        ...
        {
            entity.HasKey(e => e.UserAccountId).HasName("PK__UserAcco__DA6C70BAA1B4860A");

            entity.ToTable("UserAccount");

            entity.HasIndex(e => e.UserEmail, "UQ__UserAcco__08638DF867346054").IsUnique();
        ...
        {
            entity.HasKey(e => e.PaintingId).HasName("PK__Watercol__CF2D90F276FC65A5");
